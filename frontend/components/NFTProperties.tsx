...
const GridItem = ({ trait_type, value}: GridItemProps) => {
  return (
    ...
    <Grid className="outline outline-offset-0 px-2 py-2 rounded bidButton" style={{outlineWidth: "thin"}} item xs={12} sm={6} md={3}>
      <p className="text-green-500 font-bold py-2 px-2" style={{fontSize: 12}}>{trait_type}</p>
      <p className="text-white font-bold py-2 px-2" style={{fontSize: 15}} >{value}</p>
  ...
  return (
    <div className="nftPageProperties text-white">
      ...
      <div className="nftPageDescription" style={{textAlign: "center"}}>
        <p className="text-white font-bold py-2 px-2" style={{fontSize: 18}}>Description</p>
        <br/>
