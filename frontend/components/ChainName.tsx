              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.AVALANCE_MAINNET});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.AVALANCHE_FUJI});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.BSC});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.BSC_TESTNET});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.FANTOM_OPERA});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.FANTOM_TESTNET});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.MOONRIVER});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.MOONBASE_ALPHA});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.POLYGON_MAINNET});
                    }}
                  >
              ...
              <Menu.Item>
                {({ active }) => (
                  <button
                    ...
                    style={{fontSize:18}}
                    onClick={() => {
                      switchToNetwork({library: library, chainId: SupportedChainId.POLYGON_MUMBAI});
                    }}
                  >
