...
export default function Revenue() {
  ...
  let tabs_array = [
    <RevenueCharts category="Videos" key={1} />,
    <RevenueCharts category="Courses" key={2} />,
    <RevenueCharts category="Merch" key={3} />,
    <RevenueCharts category="Perq" key={4} />,
  ];

  const handleDrawerOpen = () => {
    setOpen(true);
    clickEvent("RevenueSliderOpen");
  };

  const handleDrawerClose = () => {
    setOpen(false);
    clickEvent("RevenueSliderClose");
  };

  return (
    <div>
      <Head>
        <title>Crezalo: My Revenue</title>
