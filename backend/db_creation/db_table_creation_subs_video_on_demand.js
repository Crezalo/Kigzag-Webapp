module.exports = async function createTablesInPostgresDB(pool) {
  ...
  await pool
    .query(
      "CREATE TABLE IF NOT EXISTS User_Video_On_Demand_Sub (Id BIGSERIAL PRIMARY KEY, UserAddress VARCHAR(255) NOT NULL, Creator VARCHAR(255) NOT NULL, Expiry_Date TIMESTAMP NOT NULL, Type INTEGER NOT NULL);"
    )
  ...
  await pool
    .query(
      "CREATE TABLE IF NOT EXISTS User_Series_Sub (Id BIGSERIAL PRIMARY KEY, UserAddress VARCHAR(255) NOT NULL, Creator VARCHAR(255) NOT NULL, SeriesId VARCHAR(255) NOT NULL, Expiry_Date TIMESTAMP NOT NULL, Type INTEGER NOT NULL);"
    )
